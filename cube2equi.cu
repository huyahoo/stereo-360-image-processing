...
int main(int argc, char** argv) {
    ...
    Mat posx = imread(prefix + "_posx.jpg");
    Mat negx = imread(prefix + "_negx.jpg");
    Mat posy = imread(prefix + "_posy.jpg");
    Mat negy = imread(prefix + "_negy.jpg");
    Mat posz = imread(prefix + "_posz.jpg");
    Mat negz = imread(prefix + "_negz.jpg");
    ...
    imwrite("output/equirectangular/" + fileName + "_EQUIRECTANGULAR.png", equirectangular);
