...
int main(int argc, char** argv) {
    ...
    imwrite("output/cube/" + fileName + "_negy.jpg", face1);
    imwrite("output/cube/" + fileName + "_posx.jpg", face2);

    imwrite("output/cube/" + fileName + "_posy.jpg", face3);
    imwrite("output/cube/" + fileName + "_negx.jpg", face4);

    imwrite("output/cube/" + fileName + "_negz.jpg", face5);
    imwrite("output/cube/" + fileName + "_posz.jpg", face6);
